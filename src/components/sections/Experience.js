  ...
  return (
    <>
      ...
      <p>
        ...
        was the Crop Wild Relatives of the United States web application. I was
        responsible for processing the images that are displayed on the map. I
        also added features the web app such as exporting the data. I also
        improved user experience by adding a loading animation when the map
        images were loading and making buttons more visible and reactive.
      </p>
      <p>
